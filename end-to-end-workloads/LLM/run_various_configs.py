            ...
            for batch_size in batch_sizes:
                ...
                try:
                    for iter in range(warmup + n_iterations):
                        ...
                        if args.breakdown and iter == warmup + n_iterations -1:
                            print("decode_step_times: ")
                            print(decode_step_times[0])
                            print()
                ...
                print("Latency (msec): %f" %duration)
                print("Throughput (token/sec): %f" %throughput)
                f.close()
